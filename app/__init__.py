...
def create_app(config_name):
    ...
    from .controller import app_bp, user_bp, bag_bp, game_bp, \
    ...
    from app.controller.ibg import AttrChModelView, EquipModelView, OStrategyModelView, DStrategyModelView, \
        ThemeModelView, FundTypeModelView
